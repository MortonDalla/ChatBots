...
cmd9 = ['thank you']
cmd122 = ['what is your name?', 'tell me your name?', 'who are you?', 'How are you doing?']
...
while True:
    ...
    with sr.Microphone() as source:
        ...
        try:
            print(" Morton you said:- " + r.recognize_google(audio))
    ...
    if r.recognize_google(audio) in greetings:
        ...
        engine.say(jokrep)
        engine.runAndWait()
    elif r.recognize_google(audio) in cmd122:
        engine.say('my name is Morton_Bot')
        print('my name is Morton_Bot')
    else:
